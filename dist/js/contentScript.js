...
var timeApi_url = 'https://worldtimeapi.org/api/timezone/';
var mainData = fetch('http://worldtimeapi.org/api/timezone/Asia/Tokyo').then(function (res) {
  return res.json();
...
var toggleLightDarkMode = function () {
...
/******/ 	__webpack_require__.O(undefined, ["dist/css/style"], () => (__webpack_require__("./assets/js/contentScript.js")))
