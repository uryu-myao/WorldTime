...
var db_body = document.querySelector('#db-body'),
    triggler_darkMode = document.querySelector('.btn-mode'),
    triggler_search = document.querySelector('.btn-new'); // Dark Mode 切り替え
...
toggleSearch.init(); // WorldTimeAPI
...
var searchShow = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = "https://timezone.abstractapi.com/v1/current_time/?api_key=be0e8b0c64a84b6a88eb4277081eec70&location=".concat(query);
            fetch(url).then(function (response) {
              ...
              // console.log(err);
              renderError("Oops, ".concat(err.message, "..."));
            });
  ...
  return function searchShow(_x) {
    return _ref.apply(this, arguments);
  };
}(); // Search logic


var searchTimeoutToken = 0;
var searchFieldElement = document.querySelector('#search-field');

searchFieldElement.onkeyup = function (event) {
  ...
  searchTimeoutToken = setTimeout(function () {
...
var timezones = [timezone1]; // Display elements

var timezonesContainer = document.querySelector('.db-body-inner');

var displayTimezones = function displayTimezones(tzs) {
  timezonesContainer.innerHTML = '';
  tzs.forEach(function (tz, i) {
    var html =
    /*html*/
    "\n      <div class=\"db-item --night\">\n        <div class=\"location\"><p class=\"city\">".concat(tz.city, "</p></div>\n        <div class=\"time\"><p class=\"clock\">23:45</p></div>\n        <div class=\"details\">\n          <div class=\"details-l\">\n            <p class=\"hlc\"></p>\n            <span class=\"bar\"></span>\n            <p class=\"hlc\">utc<span></span></p>\n          </div>\n          <div class=\"details-r\">\n            <p class=\"week\">mon</p>\n            <span class=\"bar\"></span>\n            <p class=\"month\">30 jul</p>\n          </div>\n        </div>\n      </div>\n    ");
...
/******/ 	__webpack_require__.O(undefined, ["dist/css/style"], () => (__webpack_require__("./src/js/contentScript.js")))
